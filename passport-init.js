            ...
            User.findOne({ 'username': username }, function(err, user) {
                ...
                if (user) {
                    ...
                    newUser.save(function(err) {
                        ...
                        var newSchedule = new File();
                        newSchedule.username = newUser.username;
                        newSchedule.managerId = newUser.managerId;
                        newSchedule.userFullName = newUser.fullName;
                        newSchedule.monday = "";
                        newSchedule.tuesday = "";
                        ...
                        newSchedule.save(function(err, newSchedule) {
                            ...
                            console.log(newUser.username + ' Schedule added!');
                        });
